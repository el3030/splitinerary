...
class TestBasic(unittest.TestCase):
    def setUp(self):
        ...
        self.my_flight = Plane(my_flight_number, my_departure_terminal, my_arrival_terminal,
                               departure_time=my_departure_time, arrival_time=my_arrival_time, cost=my_cost, confirmation_code=my_confirmation_code, datetime=self.now)
        ...
        self.alice_boat = Boat(alice_departure_terminal, alice_arrival_terminal, alice_route,
                               departure_time=alice_departure_time, arrival_time=alice_arrival_time, cost=alice_cost, confirmation_code=alice_confirmation_code, datetime=self.yesterday)
        ...
        # act
        self.bob_train = Train(bob_departure_station, bob_arrival_station, bob_train_line,
                               departure_time=bob_departure_time, arrival_time=bob_arrival_time, cost=bob_cost, confirmation_code=bob_confirmation_code, datetime=self.tomorrow)
    ...
    def test_basic_trip(self):
        ...
        expected_eventful_dates = [
            self.yesterday.date(), self.now.date(), self.tomorrow.date()]
        ...
        self.assertListEqual(
            eventful_dates, expected_eventful_dates)

...
class TestTransportation(unittest.TestCase):
    ...
    def test_str(self):
        ...
        date = str(now.date())
        time = str(now.time())
        expected_str = f'date: {date}, time: {time}, departure time: {departure_time}, arrival time: {arrival_time}'
        # act
        transportation = Transportation(
            departure_time, arrival_time, cost, confirmation_code, now)
        # assert
...
class TestPlane(unittest.TestCase):
    def test_create_object_success(self):
        ...
        # act
        plane = Plane(flight_number, departure_terminal, arrival_terminal,
                      departure_time=departure_time, arrival_time=arrival_time, cost=cost, confirmation_code=confirmation_code, datetime=now)
        # assert
    ...
    def test_str(self):
        ...
        expected_str = f'date: {date}, time: {time}, departure time: {departure_time}, arrival time: {arrival_time}, FLIGHT, flight_number: {flight_number}'
...
class TestTrain(unittest.TestCase):
    def test_create_object_success(self):
        ...
        # act
        train = Train(departure_station, arrival_station, train_line,
                      departure_time=departure_time, arrival_time=arrival_time, cost=cost, confirmation_code=confirmation_code, datetime=now)
        # assert
    ...
    def test_str(self):
        ...
        expected_str = f'date: {date}, time: {time}, departure time: {departure_time}, arrival time: {arrival_time}, TRAIN, departure_station: {departure_station}, arrival_station: {arrival_station}'
...
class TestBoat(unittest.TestCase):
    def test_create_object_success(self):
        ...
        # act
        boat = Boat(departure_terminal, arrival_terminal, route,
                    departure_time=departure_time, arrival_time=arrival_time, cost=cost, confirmation_code=confirmation_code, datetime=now)
        # assert
    ...
    def test_str(self):
        ...
        expected_str = f'date: {date}, time: {time}, departure time: {departure_time}, arrival time: {arrival_time}, BOAT, departure_terminal: {departure_terminal}, arrival_terminal: {arrival_terminal}'
...
class TestCar(unittest.TestCase):
    def test_create_object_success(self):
        ...
        company = 'Lyft'
        # act
        car = Car(departure_location, arrival_location, company,
                  departure_time=departure_time, arrival_time=arrival_time, cost=cost, confirmation_code=confirmation_code, datetime=now)
        # assert
    ...
    def test_str(self):
        ...
        expected_str = f'date: {date}, time: {time}, departure time: {departure_time}, arrival time: {arrival_time}, CAR, departure_location: {departure_location}, arrival_location: {arrival_location}'
